export default {
  ...
  pricing: {
    ...
    minuteRule: '1 credit per 60 minutes of audio',
  ...
  paywall: {
    title: 'You have used your free videos',
    subtitle: '{used} of {limit} free videos used. Buy credits to keep generating chapters.',
    buy: 'Continue to Stripe',
    redirecting: 'Redirecting…',
    hint: 'Stripe checkout — no password. We create your account from the email you pay with.',
    close: 'Close',
