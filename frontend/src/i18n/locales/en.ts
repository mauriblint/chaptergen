export default {
  ...
  home: {
    meta: {
      ...
      description:
        'Upload your video or audio and get AI-generated YouTube chapters instantly. No URL needed — works before you publish. Free to try, no signup.',
    },
    hero: {
      ...
      microcopy: 'Free to try · No signup required · MP4, MOV, MP3, WAV and more · Files up to 500 MB',
    },
    howItWorks: {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          question: 'Is it free?',
          answer:
            'You get 2 videos free (up to 20 minutes each) with no signup. After that, buy a credit pack — Starter is $5 for 5 videos, Creator is $12 for 15. No subscription.',
        },
        {
  ...
  podcast: {
    ...
    hero: {
      ...
      microcopy: 'Free to try · No signup required · MP3, WAV, M4A and more · Files up to 500 MB',
    },
    platforms: {
  ...
  tool: {
    uploader: {
      ...
      titleVideoCompact: 'Drop a video or audio, or click to browse',
      titleAudioCompact: 'Drop an audio file, or click to browse',
    ...
    chapterTool: {
      ...
      noSignup: '2 free videos · No signup',
    ...
    job: {
      ...
      errorFreeDuration:
        'Free videos are limited to 20 minutes. Buy credits to process longer files.',
      errorCredits:
        'This file needs more credits than you have left. Buy a pack to continue.',
    },
  },
  pricing: {
    meta: {
      title: 'Pricing — ChapterGen credit packs',
      description:
        'Try 2 videos free, then buy credits when you need more. No subscription. Starter $5 / 5 videos, Creator $12 / 15 videos.',
    },
    title: 'Simple credit packs',
    subtitle:
      'Two free videos to try the workflow. Pay only when you need more — credits never expire.',
    free: {
      name: 'Free',
      jobs: '2 videos',
      minutes: 'Up to 20 minutes each',
      signup: 'No signup',
    },
    packs: {
      starter: {
        name: 'Starter',
        blurb: 'For a short batch of uploads.',
      },
      creator: {
        name: 'Creator',
        blurb: 'Best value if you publish every week.',
      },
    },
    credits: '{count} videos',
    minuteRule: '1 credit = 1 video. Credits never expire',
    refineIncluded: 'Unlimited refine on paid videos',
    buy: 'Buy credits',
    loadError: 'Could not load pricing.',
    checkoutError: 'Could not start checkout. Try again.',
  },
  paywall: {
    title: 'Keep generating chapters',
    lead: 'Load credits once and use them whenever you want.',
    bulletExpire: '1 credit = 1 video. Credits never expire',
    bulletSize: 'Files up to 500 MB, video or audio',
    bulletPrivate: 'Works with private or unpublished videos',
    oneTime: 'One-time payment. No subscription or recurring charges.',
    choose: 'Choose your pack',
    creditsLabel: '{count} credits',
    perCredit: '{price} each',
    savePercent: 'Save {percent}%',
    continue: 'Continue — {price}',
    summary: '{count} credits · {price} each · one-time',
    ssl: 'Encrypted SSL payment · Processed by Stripe',
    ...
    reasonLabel: {
      ...
      refine: 'Refine limit reached',
      free_duration: '20-minute free limit',
      buy: 'Buy credits',
    },
    reason: {
      free_limit: 'You already used your 2 free videos. Buy credits to keep generating chapters.',
      credits: 'You have no credits left. Load a pack to generate more chapters.',
      refine: 'Free videos include 2 refines. Buy credits for unlimited refine.',
      free_duration: 'Free videos are limited to 20 minutes. Credits remove that cap.',
      buy: 'Load credits once and use them whenever you want.',
    },
  },
  login: {
    metaTitle: 'Log in — ChapterGen',
    title: 'Log in',
    subtitle: 'Enter the email you used at checkout. We will send a sign-in link — no password.',
    email: 'Email',
    placeholder: "you{'@'}example.com",
    submit: 'Send link',
    sending: 'Sending…',
    sent: 'If there is an account for that email, we sent a sign-in link. Check your inbox.',
    sendError: 'Could not send the link. Try again.',
    invalidLink: 'That link is invalid or expired. Request a new one.',
  },
  dashboard: {
    metaTitle: 'Dashboard — ChapterGen',
    title: 'My Chapters',
    subtitle: 'Generate new chapters or open one you already made.',
    loading: 'Loading…',
  ...
  settings: {
    metaTitle: 'Settings — ChapterGen',
    title: 'Settings',
    subtitle: 'Your account details. Contact us if something needs to change.',
    email: 'Email',
    language: 'Language',
    credits: 'Credits',
    google: 'Google',
  ...
  billing: {
    metaTitle: 'Billing — ChapterGen',
    title: 'Billing',
    subtitle: 'Purchases on this account.',
    payments: 'Payments',
    noPayments: 'No purchases yet.',
  },
  support: {
    title: 'Support',
    subtitle: 'Send us a message and we will reply to your account email.',
    email: 'Email',
    subject: 'Subject',
    ...
    submit: 'Send',
    sending: 'Sending…',
    sent: 'Thanks — we got your message and will reply by email.',
